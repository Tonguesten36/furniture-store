...
class fun1:
    ...
    def fun1_gui(self):
        ...
        self.label1 = Label(self.mainFrame, text="Furniture ID", bg="white", fg="black", font=("Times New Roman", 20))
        self.label1.place(x=50, y=50)
        self.label2 = Label(self.mainFrame, text="Furniture Import Date", bg="white", fg="black", font=("Times New Roman", 20))
        self.label2.place(x=50, y=120)
        self.label3 = Label(self.mainFrame, text="Furniture Name", bg="white", fg="black", font=("Times New Roman", 20))
        self.label3.place(x=50, y=190)
        self.label4 = Label(self.mainFrame, text="Furniture Import Price", bg="white", fg="black", font=("Times New Roman", 20))
        self.label4.place(x=50, y=260)
        self.label5 = Label(self.mainFrame, text="Furniture Export Price", bg="white", fg="black", font=("Times New Roman", 20))
        self.label5.place(x=50, y=330)
        self.label6 = Label(self.mainFrame, text="Furniture Quantity", bg="white", fg="black", font=("Times New Roman", 20))
        self.label6.place(x=50, y=400)
        self.label7 = Label(self.mainFrame, text="Furniture Category", bg="white", fg="black", font=("Times New Roman", 20))
        ...
        self.entry4 = Entry(self.mainFrame, width=30, font=("Times New Roman", 20), borderwidth=2, relief="groove")
        self.entry4.place(x=320, y=260)
        self.entry5 = Entry(self.mainFrame, width=30, font=("Times New Roman", 20), borderwidth=2, relief="groove")
        self.entry5.place(x=320, y=330)
        self.entry6 = Entry(self.mainFrame, width=30, font=("Times New Roman", 20), borderwidth=2, relief="groove")
        self.entry6.place(x=320, y=400)
        self.entry7 = Entry(self.mainFrame, width=30, font=("Times New Roman", 20), borderwidth=2, relief="groove")
        self.entry7.place(x=320, y=470)

        # Buttons import furnitures
